...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(this.enrolled(msg.sender), "Only enrolled addresses can deposit");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require(balances[msg.sender] >= withdrawAmount, "A user can't withrow more than the deposited amount");
